    ...
    <DialogPrimitive.Portal>
      ...
      >
        ...
        <DialogPrimitive.Close
          ...
          className="absolute right-5 top-5 grid size-10 place-items-center rounded-xl text-[var(--text-muted)] outline-none transition-colors hover:bg-[var(--surface-hover)] hover:text-[var(--text-primary)] focus-visible:ring-3 focus-visible:ring-[var(--focus)] sm:right-6 sm:top-6"
        >
