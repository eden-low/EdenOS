...
export function DashboardHeader({
  ...
  return (
    <header className="relative min-h-50 overflow-hidden rounded-[1.75rem] border border-[var(--border-subtle)] bg-[var(--hero-gradient)] p-6 shadow-[var(--shadow-soft)] sm:min-h-56 sm:p-8 lg:p-10">
      ...
      <div className="relative z-10 flex min-h-38 flex-col justify-between gap-7 sm:min-h-40 sm:flex-row sm:items-end">
        <div>
          ...
          <h1 className="max-w-3xl text-[clamp(2rem,5.5vw,3.8rem)] font-semibold leading-[1.02] tracking-[-0.055em] text-[var(--text-primary)]">
            {greeting}
          </h1>
