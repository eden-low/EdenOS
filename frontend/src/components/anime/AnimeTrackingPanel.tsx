import { CheckCircle2, Plus, PlayCircle, Search } from 'lucide-react'
  ...
  return <>
    <section className="dashboard-card mt-6 p-5 sm:p-6" aria-labelledby="tracking-heading">
      ...
      <div className="mt-5 grid gap-5 lg:grid-cols-2">
        <TrackingGroup title={t('watching')} icon={<PlayCircle aria-hidden="true" size={17} />} items={watching} onOpen={onOpen} />
        <TrackingGroup title={t('completed')} icon={<CheckCircle2 aria-hidden="true" size={17} />} items={completed} onOpen={onOpen} />
      </div>
    </section>
